				...
				<View style={styles.drawerContent}>
					<View style={styles.userInfoSection}>
						<View style={{ flexDirection: 'row', marginTop: 15 }}>
							<Avatar.Image source={require('../assets/1 (1).png')} size={80} />
							<View style={{ marginLeft: 15, flexDirection: 'column' }}>
								<Title style={styles.title}>Umukoro Chinedu</Title>
								<Caption style={styles.caption}>@nerd35</Caption>
							</View>
						</View>
						<View style={styles.row}>
							...
							<View style={styles.section}>
								<Paragraph style={[styles.paragraph, styles.caption]}>1200</Paragraph>
